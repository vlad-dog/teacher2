...
exports.run = (client, message, args) => {
    ...
    sql.get(`SELECT * FROM scores WHERE guildId ="${message.guild.id}"`).then(row => {
     ...
     const embed10 = new Discord.RichEmbed()
        ...
        .setTitle("Command: " + prefix + "welcomeleave")
	    .addField("Usage", prefix + "welcomeleave [number] [text]")
        ...
        .addField("Example", prefix + "welcomeleave 3 Welcome to %GUILDNAME%, %MENTION% has joined us.")
        ...
        if (numberpicked === 1) {
            ...
            message.channel.send("Acum am activat welcome si leave pt acest guild.")
